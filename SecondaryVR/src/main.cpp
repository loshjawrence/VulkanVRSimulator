...
private:
    ...
    void cleanup() {
        ...
        DestroyDebugReportCallbackEXT(contextInfo.instance, callback, nullptr);
    ...
    void setupDebugCallback() {
        ...
        if (CreateDebugReportCallbackEXT(contextInfo.instance, &createInfo, nullptr, &callback) != VK_SUCCESS) {
